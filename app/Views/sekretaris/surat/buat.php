               ...
               <div class="card-body">
                  <form action="<?= base_url('sekretaris/surat/simpan') ?>" method="post">
                     ...
                     <div class="form-group">
                        ...
                        <textarea name="isi_surat" class="form-control" rows="15" required><?= old('isi_surat', $template) ?></textarea>
                     </div>
                     ...
                     <div class="text-center mt-4">
                        ...
                        <button type="submit" name="action" value="simpan" class="btn btn-success">
                           <i class="fas fa-save"></i> Simpan Draft
                        </button>
                        <a href="<?= base_url('sekretaris/surat/' . $jenis_surat['kode_surat']) ?>"
