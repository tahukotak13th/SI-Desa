         ...
         <div class="container-fluid">
            <div class="card shadow mb-4">
               ...
               <div class="card-body">
                  ...
                  <form action="<?= base_url('sekretaris/perkawinan/update/' . $perkawinan['id']) ?>" method="post">
                     <?= csrf_field() ?>
                              ...
                              <select name="suami_id" class="form-control" required>
                                 ...
                                 <?php foreach ($penduduk_laki as $laki) : ?>
                                    <option value="<?= $laki['id'] ?>"
                                       <?= ($laki['id'] == $perkawinan['suami_id']) ? 'selected' : '' ?>>
                              ...
                              <select name="istri_id" class="form-control" required>
                                 ...
                                 <?php foreach ($penduduk_perempuan as $perempuan) : ?>
                                    <option value="<?= $perempuan['id'] ?>"
                                       <?= ($perempuan['id'] == $perkawinan['istri_id']) ? 'selected' : '' ?>>
                     ...
                     <div class="form-group mt-2">
                        ...
                        <select name="status" class="form-control" required>
                           ...
                           <option value="Cerai" <?= ($perkawinan['status'] == 'Cerai') ? 'selected' : '' ?>>Cerai</option>
                           <option value="Meninggal" <?= ($perkawinan['status'] == 'Meninggal') ? 'selected' : '' ?>>Meninggal</option>
                        </select>
                     </div>
